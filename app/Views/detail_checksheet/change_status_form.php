...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header bg-gradient-primary text-white py-3">
            <h5 class="card-title mb-0 text-primary">Form Perubahan Status</h5>
        </div>
        <div class="card-body">
            <form action="<?= base_url('open-ticket/update-status/' . $log['id']); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light mb-3">
                            <div class="card-header bg-light">
                                <h6 class="mb-0 text-primary">Informasi Item</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light mb-3">
                            <div class="card-header bg-light">
                                <h6 class="mb-0 text-primary">Form Perubahan</h6>
                            </div>
                            <div class="card-body">
                                <div class="form-group mb-3">
